 ...
 */
public class PaasAppOrganizationEntity {    private int id;
    private String name;
    private boolean is_tooling;
    ...
    public boolean isIs_tooling() {
        return is_tooling;
    }

    public void setIs_tooling(boolean is_tooling) {
        this.is_tooling = is_tooling;
    }
